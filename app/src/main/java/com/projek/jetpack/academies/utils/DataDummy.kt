...
object DataDummy {
    ...
    fun generateDummyCourseWithModules(course:CourseEntity,bookmarked:Boolean):CourseWithModules{
        course.bookmarked=bookmarked
        return CourseWithModules(course, generateDummyModules(course.courseId))
    }
